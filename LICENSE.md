...
- Include a link to the original repository: `https://github.com/qtremors/pygame-calculator-app`
...
```
Based on Pygame Calculator by [Tremors](https://github.com/qtremors)
https://github.com/qtremors/pygame-calculator-app
```
